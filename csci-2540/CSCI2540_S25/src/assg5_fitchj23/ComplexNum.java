...
public class ComplexNum {
	...
	/**
	 * Single parameterized constructor Sets real to inReal and imaginary to 0
	 * 
	...
	/**
	 * Two parameterized constructor Sets real to inReal and imaginary to
	 * inImaginary
	 * 
	 * @param inReal      - given real number
	...
	/**
	 * setReal method Sets real to inReal
	 * 
	...
	/**
	 * setImaginary method Sets imaginary to inImaginary
	 * 
	...
	/**
	 * add method Adds two complex numbers together using the formula: (a + bi) + (c
	 * + di) = (a + c) + (b + d)i
	 * 
	...
	/**
	 * sub method Subtracts two complex numbers using the formula: (a + bi) - (c +
	 * di) = (a - c) + (b - d)i
	 * 
	...
	/**
	 * mul method Multiplies two complex numbers using the formula: (a + bi)(c + di)
	 * = (ac - bd) + (ad + bc)i
	 * 
	...
	/**
	 * neg method Negates a complex number using the formula: -(a + bi) = -a - bi
	 * 
	...
	/**
	 * equals method Compares two complex numbers
	 * 
